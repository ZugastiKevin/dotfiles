...
# Add a custom info line
    ...
    # ===== BAR =====
    function info_bar_top. {
        return @{
            content = "${e}[1;30m┌─────────────────────────────────────────────────────────┐"
        }
    }

    function info_bar_bottom. {
        return @{
            content = "${e}[1;30m└─────────────────────────────────────────────────────────┘"
        }
    }
    ...
    function info_colors. {
        return @{
            content = ("${e}[${t};0m  ${e}[${t};30m  ${e}[${t};31m  ${e}[${t};32m  ${e}[${t};33m  ${e}[${t};34m  ${e}[${t};35m  ${e}[${t};36m  ${e}[${t};37m       ${e}[${t};90m  ${e}[${t};91m  ${e}[${t};92m  ${e}[${t};93m  ${e}[${t};94m  ${e}[${t};95m  ${e}[${t};96m  ${e}[${t};97m  ${e}[${t};0m ")
        }
    }
    ...
    function info_title. {
        return @{
            content = "${e}[1;33m{0}${e}[37m@${e}[1;33m{1}${e}[0m" -f [System.Environment]::UserName,$env:COMPUTERNAME
        }
    }
    ...
    function info_os. {
        return @{
            title   = "${e}[1;30m ${e}[1;33mOS "
            content = "Microsoft"
        }
    }

    function info_distro. {
        return @{
            title   = "${e}[1;30m│ ├${e}[1;33m "
    ...
    function info_motherboard. {
        ...
        return @{
            title = "${e}[1;30m│ ├${e}[1;33m  "
            content = "{0}" -f $motherboard.Product
        }
    }
            ...
            if ($showDisks.Contains($diskLetter) -or $showDisks.Contains("*")) {
                try {
                    if ($_.TotalSize -gt 0) {
                        ...
                        [void]$lines.Add(@{
                            title   = "${e}[1;30m│ ├${e}[1;33m  ($diskLetter)"
    ...
    function info_weather. {
        return @{
            title = "${e}[1;30m│ └${e}[1;33m󰙾 "
            content = try {
                (Invoke-RestMethod -TimeoutSec 5 wttr.in/?format="%t+-+%C").TrimStart("+")
            } catch {
                "$e[91m(Network Error)"
            }
        }
